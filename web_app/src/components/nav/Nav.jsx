...
function Nav() {
  ...
  return (
    ...
    <SidebarContext.Consumer>{(sidebarContext)=>{
      ...
      <div className='nav'>    
        <h3 className="title" style={{display: context.displayMode}}>Navegação</h3>
        
        <Link to={'/'} className="navBtns__items btn1">
          <img src={Description_icon} alt='icon'/>
          <span className='icons_titles' style={{display: context.displayMode}}>Descrissão</span></Link>
        <Link to={'/analises'} className="navBtns__items btn2">
          <img src={Query_icon} alt='icon'/>
          <span className='icons_titles' style={{display: context.displayMode}}>Analise</span>
        </Link>
        <Link to={'/dashboard'} className="navBtns__items btn3">
          <img src={Dashboard_icon} alt='icon'/>
          <span className='icons_titles' style={{display: context.displayMode}}>Dashboard</span>
        </Link>
    </div>
    )}}
